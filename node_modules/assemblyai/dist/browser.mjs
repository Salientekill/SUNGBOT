...
async function resolveSource(input) {
    if (typeof input === "string") {
        ...
        return {
            chunks: singleChunk(await readStream(await readFile())),
            filename,
            suffix: extname(filename),
        };
    }
