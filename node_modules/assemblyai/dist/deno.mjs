...
const defaultUserAgent = {
    sdk: { name: "JavaScript", version: "4.37.1" },
};
...
export { AssemblyAI, BrowserOnlyError, DualChannelCapture, EnergyVad, FileService, LinearResampler, RealtimeService, RealtimeServiceFactory, RealtimeTranscriber, RealtimeTranscriberFactory, StreamingTranscriber, SyncTranscriber, SyncTranscriptError, TranscriptService, VadTimeline, attributeTurn, attributeWord, defaultSyncSpeechModel, float32ToPcm16, rollUpTurnChannel };
