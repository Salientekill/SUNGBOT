...
function isIterable(input) {
    ...
    return (typeof (candidate === null || candidate === void 0 ? void 0 : candidate[Symbol.asyncIterator]) === "function" ||
        typeof (candidate === null || candidate === void 0 ? void 0 : candidate[Symbol.iterator]) === "function");
}
/**
 ...
 */
function liveChunks(input) {
    return __asyncGenerator(this, arguments, function* liveChunks_1() {
        var _a, e_1, _b, _c;
        if (isWebReadableStream(input)) {
            ...
            try {
                for (;;) {
                    ...
                    yield yield __await(asBytes(value));
                }
            }
            finally {
                reader.releaseLock();
            ...
            try {
                for (var _d = true, _e = __asyncValues(input), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const chunk = _c;
                    yield yield __await(asBytes(chunk));
                }
            }
                    ...
                    try {
                        for (;;) {
                            ...
                            const next = finished
                                ...
                                : yield Promise.race([iterator.next(), finishing]);
                            if (next.done) {
                                if (finished)
                                    void ((_a = iterator.return) === null || _a === void 0 ? void 0 : _a.call(iterator).catch(() => undefined));
        ...
        return __asyncGenerator(this, arguments, function* _a() {
            for (;;) {
                if (this.items.length > 0) {
                    yield yield __await(this.items.shift());
                    continue;
                }
                if (this.ended)
                    return yield __await(void 0);
 ...
 */
function errorFromResponse$1(response, factory, label) {
    return __awaiter(this, void 0, void 0, function* () {
        let errorCode;
        let message;
        const text = yield response.text();
...
function resolveFormat(config, suffix, filename, contentTypes, configName) {
    ...
    const contentType = isPcm
        ? "audio/pcm"
        : ((_a = contentTypes[suffix]) !== null && _a !== void 0 ? _a : defaultContentType);
    return {
        filename: filename !== null && filename !== void 0 ? filename : (isPcm ? "audio.pcm" : "audio.wav"),
        contentType,
    };
}
/**
...
const defaultLiveTimeoutMs$1 = 180000;
const warmTimeoutMs$1 = 10000;
...
class SyncTranscriber extends BaseService {
    ...
    transcribe(audio_1) {
        return __awaiter(this, arguments, void 0, function* (audio, config = {}, options = {}) {
            ...
            const signal = deadlineSignal((_a = options.timeout) !== null && _a !== void 0 ? _a : defaultLiveTimeoutMs$1, options.signal);
            return yield this.postLive(singleChunk$1(bytes), audio, config, signal, {
                filename,
                contentType,
            });
        });
     ...
     */
    transcribeLive(audio_1) {
        return __awaiter(this, arguments, void 0, function* (audio, config = {}, options = {}) {
            var _a;
            checkLiveInput(audio);
            const signal = deadlineSignal((_a = options.timeout) !== null && _a !== void 0 ? _a : defaultLiveTimeoutMs$1, options.signal);
            return yield this.postLive(liveChunks(audio), audio, config, signal);
        });
    }
    /**
    ...
    openLive(config = {}, options = {}) {
        return new SyncLiveSession((chunks, abortSignal) => {
            var _a;
            return this.postLive(chunks, undefined, config, deadlineSignal((_a = options.timeout) !== null && _a !== void 0 ? _a : defaultLiveTimeoutMs$1, abortSignal));
        });
    }
    /**
     ...
     */
    postLive(chunks, source, config, signal, format) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const { filename, contentType } = format !== null && format !== void 0 ? format : resolveLiveFormat(source, config);
            ...
            let response;
            try {
                response = yield this.fetchResponse(transcribeLiveEndpoint$1, {
                    method: "POST",
                    body: body.stream,
                    headers: {
                        [modelHeader]: (_a = config.model) !== null && _a !== void 0 ? _a : defaultSyncSpeechModel,
                ...
                throw (_b = body.error) !== null && _b !== void 0 ? _b : error;
            }
            if (response.status !== 200) {
                ...
                body.finish();
                throw yield syncError(response);
            }
    ...
    warm(params) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                yield this.fetchResponse(warmEndpoint$1, {
                    method: "GET",
...
function singleChunk$1(bytes) {
    return __asyncGenerator(this, arguments, function* singleChunk_1() {
        yield yield __await(bytes);
    });
}
/**
...
function resolveAudio(input, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Object.assign({ bytes }, resolveFormat(config, suffix, filename, contentTypes$1, configName$1));
    });
}
/**
...
function resolveLiveFormat(source, config) {
    const path = source === null || source === void 0 ? void 0 : source.path;
...
function syncError(response) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield errorFromResponse$1(response, SyncTranscriptError, "sync transcription");
    });
}
...
const defaultLiveTimeoutMs = 300000;
...
class DictationTranscriber extends BaseService {
    ...
    transcribeLive(audio_1) {
        return __awaiter(this, arguments, void 0, function* (audio, config = {}, options = {}) {
            var _a;
            const source = yield resolveSource(audio);
            const { filename, contentType } = resolveFormat(config, source.suffix, source.filename, contentTypes, configName);
            const signal = deadlineSignal((_a = options.timeout) !== null && _a !== void 0 ? _a : defaultLiveTimeoutMs, options.signal);
            return yield this.postLive(source.chunks, filename, contentType, config, signal);
        });
    }
    /**
     ...
     */
    openLive(config = {}, options = {}) {
        return new DictationLiveSession((chunks, abortSignal) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            return yield this.postLive(chunks, filename, contentType, config, deadlineSignal((_a = options.timeout) !== null && _a !== void 0 ? _a : defaultLiveTimeoutMs, abortSignal));
        }));
    }
    /**
     ...
     */
    postLive(chunks, filename, contentType, config, signal) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const boundary = multipartBoundary();
            const body = liveBody({
            ...
            let response;
            try {
                response = yield this.fetchResponse(transcribeLiveEndpoint, {
                    method: "POST",
                    body: body.stream,
                    headers: {
                        "Content-Type": `multipart/form-data; boundary=${boundary}`,
                ...
                // fetch reports a failed request body as an opaque "fetch failed";
                // surface what the producer actually threw.
                throw (_a = body.error) !== null && _a !== void 0 ? _a : error;
            }
            if (response.status !== 200) {
                // The server can reject while the upload is still in flight (auth,
                ...
                body.finish();
                throw yield errorFromResponse$1(response, DictationError, "dictation transcription");
            }
            ...
            return Object.assign(Object.assign({}, json), { final_text: (_b = json.llm_response) !== null && _b !== void 0 ? _b : json.text });
        });
    }
    /**
...
function resolveSource(input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof input === "string") {
            ...
            return {
                chunks: singleChunk(yield readStream(yield readFile())),
                filename,
                suffix: extname(filename),
            };
        }
        ...
        if (input instanceof Blob) {
            const bytes = new Uint8Array(yield input.arrayBuffer());
            // File instances carry a name; the File global itself needs Node >= 20.
            const name = input.name;
...
const { WritableStream: WritableStream$1 } = typeof window !== "undefined"
    ? window
        ...
        return new Promise((resolve, reject) => {
            ...
            this.socket.onmessage = ({ data }) => {
                ...
                switch (message.type) {
                    ...
                    case "Silence": {
                        (_t = (_s = this.listeners).silence) === null || _t === void 0 ? void 0 : _t.call(_s, message);
                        break;
                    }
                    case "Termination": {
                        this.resolveSessionTermination();
...
class AssemblyAI {
    ...
    constructor(params) {
        ...
        this.dictation = new DictationTranscriber(Object.assign(Object.assign({}, params), { baseUrl: dictationBaseUrl }));
