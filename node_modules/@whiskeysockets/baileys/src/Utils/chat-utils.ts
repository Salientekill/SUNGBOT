...
export const processSyncAction = (
	...
	if (action?.muteAction) {
		...
		// PR #2057: Emit channels personalised recommendation settings update
		ev.emit('settings.update', {
