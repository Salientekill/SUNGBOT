...
export interface ParseE2ESessionsResult {
	injected: string[]  // JIDs injetados com sucesso
	failed: string[]    // JIDs que falharam (número inválido, usuário não existe, etc)
}
...
export const parseAndInjectE2ESessions = async (
	...
	logger?: ILogger
): Promise<ParseE2ESessionsResult> => {
