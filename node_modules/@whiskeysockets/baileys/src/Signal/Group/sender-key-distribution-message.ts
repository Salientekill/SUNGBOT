	...
	constructor(
		...
		if (serialized) {
			try {
				...
				// console.log(`[SenderKeyDistributionMessage] Decodificado: id=${this.id}, iteration=${this.iteration}, chainKeyLen=${this.chainKey?.length}, signatureKeyLen=${this.signatureKey?.length}`)
			} catch (e) {
