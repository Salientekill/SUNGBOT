...
import type { BinaryNode } from './BinaryNode.js';
...
export type MediaGenerationOptions = {
     ...
     */
    processMedia?: (media: Buffer, mediaType: BridgeMediaType, waClient: MediaGenerationOptions['waClient']) => Promise<{
