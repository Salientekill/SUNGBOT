import { initAuthCreds } from '../../Utils/generics.js';
import { projectNativeStore } from '../legacy-store/native-projection.js';
/**
 ...
 */
export const normalizeSocketAuthenticationState = (input) => {
