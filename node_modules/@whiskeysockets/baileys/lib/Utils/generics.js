...
export const fetchLatestWaWebVersion = async (options = {}) => {
    try {
        // Use random user-agent from pool to avoid static fingerprinting
        const { getRandomUserAgent } = await import('./browser-utils.js');
        // Complete headers to avoid bot detection (inspired by successful scraping techniques)
