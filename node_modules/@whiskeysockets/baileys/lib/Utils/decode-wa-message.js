...
import { areJidsSameUser, isJidBroadcast, isJidGroup, isJidHostedLidUser, isJidHostedPnUser, isJidMetaAI, isJidNewsletter, isJidStatusBroadcast, isLidUser, isPnUser
//	transferDevice
...
export function decodeMessageNode(stanza, meId, meLid) {
    ...
    if (!msgId || !from) {
        throw new Boom('Received message stanza with missing id or from', { data: stanza, statusCode: 400 });
    }
