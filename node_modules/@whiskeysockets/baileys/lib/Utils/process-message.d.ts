 ...
 */
export declare const getChatId: ({ remoteJid, participant, fromMe }: WAMessageKey, logger?: ILogger) => string | undefined;
type PollContext = {
...
declare const processMessage: (message: WAMessage, { shouldProcessHistoryMsg, placeholderResendCache, ev, creds, signalRepository, keyStore, logger, options, storePrivacyTokens }: ProcessMessageContext) => Promise<void>;
