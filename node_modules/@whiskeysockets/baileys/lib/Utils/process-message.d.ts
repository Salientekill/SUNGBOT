...
declare const processMessage: (message: WAMessage, { shouldProcessHistoryMsg, placeholderResendCache, ev, creds, signalRepository, keyStore, logger, options, storePrivacyTokens, getMessage }: ProcessMessageContext) => Promise<void>;
