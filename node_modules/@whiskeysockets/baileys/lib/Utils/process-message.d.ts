...
declare const processMessage: (message: WAMessage, { shouldProcessHistoryMsg, placeholderResendCache, ev, creds, signalRepository, keyStore, logger, options, assertSessions, sendProactiveSenderKey }: ProcessMessageContext) => Promise<void>;
