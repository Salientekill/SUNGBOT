...
import type { WAMessageUpdate } from '../Types/Message.js';
 ...
 */
export declare const invalidateRecentMessageOnUpdate: (manager: MessageRetryManager, { key, update }: WAMessageUpdate) => boolean;
