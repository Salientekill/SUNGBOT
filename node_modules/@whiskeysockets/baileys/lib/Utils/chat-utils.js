...
import { emitSyncActionResults, processContactAction, SyncdMissingKeyError } from './sync-action-utils.js';
...
const makeLtHashGenerator = ({ indexValueMap, hash }, logger) => {
...
export const decodeSyncdPatch = async (msg, name, initialState, getAppStateSyncKey, onMutation, validateMacs, logger) => {
    if (validateMacs) {
