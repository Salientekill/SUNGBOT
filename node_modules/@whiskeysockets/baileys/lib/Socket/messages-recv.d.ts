...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    requestPlaceholderResend: (messageKey: WAMessageKey, forceImmediate?: boolean) => Promise<string | undefined>;
    ...
    registerBotPromotion: (groupJid: string) => void;
    invalidateAdminCache: (groupJid: string) => void;
    registerBotEntry: (groupJid: string, groupSize?: number) => void;
    updateMemberLabel: (jid: string, memberLabel: string | null) => Promise<string>;
    updateMediaMessage: (message: WAMessage) => Promise<WAMessage>;
    sendMessage: (jid: string, content: import("../index.js").AnyMessageContent, options?: import("../index.js").MiscMessageGenerationOptions) => Promise<WAMessage | undefined>;
