        ...
        await authState.keys.transaction(async () => {
            ...
            while (collectionsToHandle.size) {
                ...
                for (const key in decoded) {
                    ...
                    try {
                        if (snapshot) {
                            const { state: newState, mutationMap } = await decodeSyncdSnapshot(name, snapshot, getAppStateSyncKey, initialVersionMap[name], appStateMacVerification.snapshot, logger);
