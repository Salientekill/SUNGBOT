...
export declare const makeCommunitiesSocket: (config: SocketConfig) => {
    ...
    downloadMediaMessage: <Type extends "buffer" | "stream">(message: import("../Types/index.js").WAMessage, type: Type, options: import("../Utils/index.js").MediaDownloadOptions, ctx?: {
        reuploadRequest: (msg: import("../Types/index.js").WAMessage) => Promise<import("../Types/index.js").WAMessage>;
        logger: import("../Utils/logger.js").ILogger;
    } | undefined) => Promise<Type extends "buffer" ? Buffer<ArrayBufferLike> : import("stream").Transform>;
    downloadContentFromMessage: ({ mediaKey, directPath, url }: import("../Types/index.js").DownloadableMessage, type: import("../index.js").MediaType, opts?: import("../Utils/index.js").MediaDownloadOptions) => Promise<import("stream").Transform>;
