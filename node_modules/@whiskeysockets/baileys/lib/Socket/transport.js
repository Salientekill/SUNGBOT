const asWebSocketPayload = (data) => data.buffer instanceof ArrayBuffer
...
export const makeTransport = (config) => {
    ...
    return {
        ...
        async disconnect() {
            ...
            if (toClose.readyState === WebSocket.CLOSED)
                return;
...
export const makeHttpClient = (config) => ({
