...
import { areJidsSameUser, getBinaryNodeChild, getBinaryNodeChildren, isJidGroup, isJidHostedLidUser, isJidHostedPnUser, isLidUser, isPnUser, jidDecode, jidEncode, jidNormalizedUser, S_WHATSAPP_NET } from '../WABinary/index.js';
    ...
    const createParticipantNodes = async (recipientJids, message, extraAttrs, dsmMessage) => {
        ...
        results.forEach((result, i) => {
            if (result.status === 'fulfilled') {
                ...
                const failedId = patchedMessages[i]?.recipientJid;
