...
import { areJidsSameUser, getBinaryNodeChild, getBinaryNodeChildren, getServerFromDomainType, isJidGroup, isHostedLidUser, isHostedPnUser, isLidUser, isPnUser, jidDecode, jidEncode, jidNormalizedUser, S_WHATSAPP_NET } from '../WABinary/index.js';
    ...
    const assertSessions = async (jids) => {
        ...
        if (jidsRequiringFetch.length) {
            ...
            const wireJids = [
                ...
                ...((await signalRepository.lidMapping.getLIDsForPNs(jidsRequiringFetch.filter(jid => !!jid.includes('@s.whatsapp.net') || !!jid.includes('@hosted')))) || []).map(a => a.lid)
            ];
