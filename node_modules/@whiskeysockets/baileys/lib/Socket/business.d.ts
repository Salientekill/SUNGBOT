...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    downloadMediaMessage: <Type extends "buffer" | "stream">(message: import("../index.js").WAMessage, type: Type, options: import("../index.js").MediaDownloadOptions, ctx?: {
        reuploadRequest: (msg: import("../index.js").WAMessage) => Promise<import("../index.js").WAMessage>;
        logger: import("../Utils/logger.js").ILogger;
    } | undefined) => Promise<Type extends "buffer" ? Buffer<ArrayBufferLike> : import("stream").Transform>;
    downloadContentFromMessage: ({ mediaKey, directPath, url }: import("../index.js").DownloadableMessage, type: import("../index.js").MediaType, opts?: import("../index.js").MediaDownloadOptions) => Promise<import("stream").Transform>;
    ...
    authState: {
        ...
        keys: import("../index.js").SignalKeyStoreWithRecordTransaction;
    };
