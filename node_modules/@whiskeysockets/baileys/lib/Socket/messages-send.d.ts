...
import type { AnyMessageContent, MessageReceiptType, MessageRelayOptions, MiscMessageGenerationOptions, SocketConfig, WAMessage, WAMessageKey } from '../Types/index.js';
...
export declare const makeMessagesSocket: (config: SocketConfig) => {
    ...
    getMediaUrl: (directPath: string) => string;
    /**
     ...
     */
    downloadMediaMessage: <Type extends "buffer" | "stream">(message: WAMessage, type: Type, options: import("../Utils/index.js").MediaDownloadOptions, ctx?: {
        reuploadRequest: (msg: WAMessage) => Promise<WAMessage>;
        logger: import("../Utils/logger.js").ILogger;
    } | undefined) => Promise<Type extends "buffer" ? Buffer<ArrayBufferLike> : import("stream").Transform>;
    /**
     * Lower-level helper if you already have a `DownloadableMessage`
     * (e.g. extracted from a quoted message). Auto-injects the
     * socket's `mediaHost`.
     */
    downloadContentFromMessage: ({ mediaKey, directPath, url }: import("../Types/index.js").DownloadableMessage, type: import("../Defaults/index.js").MediaType, opts?: import("../Utils/index.js").MediaDownloadOptions) => Promise<import("stream").Transform>;
