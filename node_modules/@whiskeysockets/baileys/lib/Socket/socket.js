...
const makeSocket = (config) => {
    ...
    const ephemeralKeyPair = crypto_2.Curve.generateKeyPair();
    ...
    async function generatePairingKey() {
        ...
        const key = await (0, crypto_2.derivePairingCodeKey)(authState.creds.pairingCode, salt);
        const ciphered = (0, crypto_2.aesEncryptCTR)(authState.creds.pairingEphemeralKeyPair.public, key, randomIv);
