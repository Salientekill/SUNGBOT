...
class GroupCipher {
    ...
    async getPlainText(iv, key, ciphertext) {
        try {
            return (0, crypto_1.signalDecrypt)(Buffer.from(key), Buffer.from(ciphertext), Buffer.from(iv));
        }
        catch (e) {
    ...
    async getCipherText(iv, key, plaintext) {
        try {
            ...
            return (0, crypto_1.signalEncrypt)(Buffer.from(keyBuffer), Buffer.from(plaintextBuffer), Buffer.from(ivBuffer));
        }
        catch (e) {
            throw new Error('InvalidMessageException');
        }
