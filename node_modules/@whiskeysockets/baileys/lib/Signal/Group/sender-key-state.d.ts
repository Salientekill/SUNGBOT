...
export declare class SenderKeyState {
    ...
    } | null, signatureKeyPublic?: Uint8Array | string | null, signatureKeyPrivate?: Uint8Array | string | null, senderKeyStateStructure?: SenderKeyStateStructure | unknown | null);
    /**
     ...
     */
    private validateChainKey;
    /**
     * Valida a estrutura de signingKey
     */
    private validateSigningKey;
    /**
     * Valida e limpa o array de messageKeys
     */
    private validateMessageKeys;
    getKeyId(): number;
