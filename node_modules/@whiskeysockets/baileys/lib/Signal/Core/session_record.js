...
class SessionEntry {
    ...
    toString() {
        var _a, _b;
        const baseKey = (_b = (_a = this.indexInfo) === null || _a === void 0 ? void 0 : _a.baseKey) === null || _b === void 0 ? void 0 : _b.toString('base64');
        ...
        for (const key of Object.keys(chains)) {
            ...
            r[key] = {
                chainKey: {
                    ...
                    key: (_a = c.chainKey.key) === null || _a === void 0 ? void 0 : _a.toString('base64')
                },
...
class SessionRecord {
    ...
    getSession(key) {
        ...
        if (session && session.indexInfo.baseKeyType === base_key_type_1.default.OURS) {
    ...
    getSessions() {
        ...
        return Array.from(Object.values(this.sessions))
            ...
            .sort((a, b) => {
            var _a, _b;
            const aUsed = ((_a = a.indexInfo) === null || _a === void 0 ? void 0 : _a.used) || 0;
            const bUsed = ((_b = b.indexInfo) === null || _b === void 0 ? void 0 : _b.used) || 0;
