...
import { isTcTokenExpired, resolveTcTokenJid, shouldSendNewTcToken, storeTcTokensFromIqResult } from '../Utils/tc-token-utils.js';
...
export const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            // Skip protocol messages (edits, deletes, reactions) — they share the
            // same msgId as the original and would overwrite the cached content,
            // causing the retry mechanism to resend stale or protocol data.
            if (messageRetryManager && !participant) {
                const innerContent = normalizeMessageContent(message);
