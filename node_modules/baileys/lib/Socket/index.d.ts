...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    createParticipantNodes: (recipientWireJids: string[], message: import("../index.js").proto.IMessage, extraAttrs?: import("../index.js").BinaryNode["attrs"], dsmMessage?: import("../index.js").proto.IMessage) => Promise<{
