...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    createParticipantNodes: (recipientWireJids: string[], message: import("../index.js").proto.IMessage, extraAttrs?: BinaryNode["attrs"], dsmMessage?: import("../index.js").proto.IMessage) => Promise<{
        nodes: BinaryNode[];
