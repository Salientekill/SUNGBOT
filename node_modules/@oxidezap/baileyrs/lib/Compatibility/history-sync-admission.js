...
import { DEFAULT_CONNECTION_CONFIG, PROCESSABLE_HISTORY_TYPES } from '../Defaults/index.js';
import { proto as protoRuntime } from '../WAProto/runtime.js';
/**
 ...
 */
export const historySyncNotificationFromMetadata = (metadata) => {
    const fields = {};
    if (metadata.syncType !== undefined) {
        fields.syncType = metadata.syncType;
    }
 ...
 */
export const resolveHistorySyncPolicy = (configured) => configured ?? DEFAULT_CONNECTION_CONFIG.shouldSyncHistoryMessage;
/**
 ...
 */
export const isHistorySyncFullyDisabled = (shouldSyncHistoryMessage) => PROCESSABLE_HISTORY_TYPES.every(syncType => {
    try {
        return shouldSyncHistoryMessage({ syncType }) === false;
    }
    catch {
        return false;
    }
 ...
 */
export const makeHistorySyncAdmission = (shouldSyncHistoryMessage) => ({
    historySyncAdmission: metadata => {
        ...
        return accepted && PROCESSABLE_HISTORY_TYPES.includes(notification.syncType);
    }
});
//# sourceMappingURL=history-sync-admission.js.map