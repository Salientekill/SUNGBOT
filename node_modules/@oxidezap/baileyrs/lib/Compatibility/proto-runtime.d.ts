 ...
 */
export declare const projectProtoMessage: (path: string, message: unknown) => unknown;
...
export declare const createProtoCompatibilityFacade: (sourceNamespace: DynamicObject) => ProtoCompatibilityFacade;
export {};
//# sourceMappingURL=proto-runtime.d.ts.map