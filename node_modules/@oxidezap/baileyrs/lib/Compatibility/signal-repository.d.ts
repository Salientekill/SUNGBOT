...
export declare const makeDefaultSignalRepository: (auth: SignalAuthState, logger: ILogger, _pnToLIDFunc?: (jids: string[]) => Promise<LIDMapping[] | undefined>) => SignalRepositoryWithLIDStore;
/** Translate the neutral bridge Signal surface into the public repository contract. */
export declare const makeSignalRepository: (ctx: SignalRepositoryContext) => SignalRepositoryWithLIDStore;
export {};
//# sourceMappingURL=signal-repository.d.ts.map