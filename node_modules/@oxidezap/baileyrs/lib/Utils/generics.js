...
import { getAllBinaryNodeChildren } from '../WABinary/generic-utils.js';
...
export const encodeBigEndian = (value, length = 4) => {
    let remaining = value;
...
export const unixTimestampSeconds = (date) => Math.floor((date ? date.getTime() : Date.now()) / 1000);
/**
...
export async function promiseTimeout(ms, 
...
export const getStatusFromReceiptType = (type) => type === undefined ? proto.WebMessageInfo.Status.DELIVERY_ACK : STATUS_MAP[type];
