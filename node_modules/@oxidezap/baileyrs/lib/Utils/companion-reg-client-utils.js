import { makeNumericEnum } from '../Compatibility/internal/numeric-enum.js';
...
export const CompanionWebClientType = makeNumericEnum(CompanionWebClientTypeValues);
...
export const buildPairingQRData = (ref, noiseKeyB64, identityKeyB64, advB64, browser) => 'https://wa.me/settings/linked_devices#' +
