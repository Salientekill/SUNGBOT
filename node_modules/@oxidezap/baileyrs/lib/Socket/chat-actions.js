export const makeChatActionMethods = (ctx) => ({
     ...
     */
    fetchDisappearingDuration: async (..._jids) => {
        ctx.logger.warn('fetchDisappearingDuration: not yet available in bridge mode — listen for disappearing_mode_changed events instead');
        return undefined;
    }
});
