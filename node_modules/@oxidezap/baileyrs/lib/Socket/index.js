...
import { makeHistorySyncAdmission, resolveHistorySyncPolicy, isHistorySyncFullyDisabled } from '../Compatibility/history-sync-admission.js';
 ...
 */
const browserToPlatformType = (browser) => {
    switch (browser) {
        case 'Chrome':
            return 'CHROME';
        case 'Firefox':
...
const makeWASocket = (config) => {
    ...
    const init = async () => {
        ...
        // Absent stays strict.
        fullConfig.dangerSkipCertChainVerify, makeHistorySyncAdmission(shouldSyncHistoryMessage));
