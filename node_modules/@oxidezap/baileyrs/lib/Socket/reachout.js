...
export function extractReachoutPayload(value) {
    ...
    if (data && typeof data === 'object') {
        const inner = data['xwa2_fetch_account_reachout_timelock'];
...
export function mapReachoutTimelock(value) {
    ...
    if (wire.enforcement_type) {
        state.enforcementType = wire.enforcement_type;
    }
    return state;
}
//# sourceMappingURL=reachout.js.map